...
public class Loops {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(loopE("swag 1"));
        System.out.println(loopE("swag 2"));
        System.out.println(loopE("swag 3"));

        System.out.println(stringTimes("I am god", 10));

        System.out.println(stringZ("cupcakes"));
